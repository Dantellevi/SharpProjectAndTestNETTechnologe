...
namespace CarClientWinForm.CARService {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(CarClientWinForm.CARService.TruckCar))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(CarClientWinForm.CARService.PassegerCar))]
    ...
    [System.SerializableAttribute()]
    public partial class TruckCar : CarClientWinForm.CARService.Car {
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private double CapasityField;
    ...
    [System.SerializableAttribute()]
    public partial class PassegerCar : CarClientWinForm.CARService.Car {
    ...
    public interface ICarService {
        ...
        void SetCar(CarClientWinForm.CARService.Car c);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICarService/SetCar", ReplyAction="http://tempuri.org/ICarService/SetCarResponse")]
        System.Threading.Tasks.Task SetCarAsync(CarClientWinForm.CARService.Car c);
        ...
        CarClientWinForm.CARService.Car GetCar(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICarService/GetCar", ReplyAction="http://tempuri.org/ICarService/GetCarResponse")]
        System.Threading.Tasks.Task<CarClientWinForm.CARService.Car> GetCarAsync(int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICarServiceChannel : CarClientWinForm.CARService.ICarService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CarServiceClient : System.ServiceModel.ClientBase<CarClientWinForm.CARService.ICarService>, CarClientWinForm.CARService.ICarService {
        ...
        public void SetCar(CarClientWinForm.CARService.Car c) {
            base.Channel.SetCar(c);
        }
        
        public System.Threading.Tasks.Task SetCarAsync(CarClientWinForm.CARService.Car c) {
            return base.Channel.SetCarAsync(c);
        }
        
        public CarClientWinForm.CARService.Car GetCar(int id) {
            return base.Channel.GetCar(id);
        }
        
        public System.Threading.Tasks.Task<CarClientWinForm.CARService.Car> GetCarAsync(int id) {
